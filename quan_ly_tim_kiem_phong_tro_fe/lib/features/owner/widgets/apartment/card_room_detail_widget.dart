...
class _CardRoomDetailWidgetState extends State<CardRoomDetailWidget> {
  ...
  void initState() {
    ...
    roomCodeController = TextEditingController(
      text: widget.initialData.roomCode,
    );
    depositPriceController = TextEditingController(
      text: widget.initialData.depositPrice.isEmpty
          ? '0'
          : widget.initialData.depositPrice,
    );
    ...
    checkoutController = TextEditingController(
      text: widget.initialData.checkout,
    );
    capacityController = TextEditingController(
      text: widget.initialData.maxCapacity,
    );
    statusController = TextEditingController(
      text: widget.initialData.room_status,
    );
    ...
    priceController = TextEditingController(
      text: _formatCurrency(
        widget.initialData.price.replaceAll(RegExp(r'[^0-9]'), ''),
      ),
    );
    ...
    requirementController = TextEditingController(
      text: widget.initialData.requirement,
    );
    ...
    selectedRoomType = widget.initialData.roomType.isNotEmpty
        ? widget.initialData.roomType
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          enabled: selectedRoomState != ApartmentStatus.rented,
                        ...
                        child: InkWell(
                          ...
                          onTap: isCheckingRoomCode
                              ...
                              : () async {
                                  ...
                                  final isUnique = await ApartmentController()
                                      .isRoomCodeUnique(
                      ...
                      Material(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            final randomCode = await ApartmentController()
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            filled: true,
                            fillColor: Colors.white,
                            suffixIcon: const Icon(Icons.schedule, color: Color(0xFF4C6FFF)),
                          ),
                          onTap: selectedRoomState != ApartmentStatus.rented
                              ? () async {
                                  ...
                                  if (time != null) {
                                    setState(() {
                                      checkinController.text = time.format(context);
                                    });
                                  }
                                }
                              : null,
                        ...
                        child: TextFormField(
                          ...
                          onTap: selectedRoomState != ApartmentStatus.rented
                              ? () async {
                                  ...
                                  if (time != null) {
                                    setState(() {
                                      checkoutController.text = time.format(context);
                                    });
                                  }
                                }
                              : null,
            ...
            Column(
              ...
              children: [
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              keyboardType: TextInputType.number,
                              enabled:
                                  selectedRoomState != ApartmentStatus.rented,
                              decoration: InputDecoration(
                                contentPadding: const EdgeInsets.symmetric(
                                  horizontal: 12,
                                  vertical: 12,
                ...
                Container(
                  ...
                  child: IgnorePointer(
                    ignoring: selectedRoomState == ApartmentStatus.rented,
                                    ...
                                    SizedBox(
                                      ...
                                      child: ListView(
                                        children: filteredUtilities.map((u) {
                                          final isChecked = selectedUtilities
                                              .contains(u);
                ...
                if (selectedUtilities.isNotEmpty)
                  Wrap(
                    ...
                    children: allUtilities
                        .where(
                          (u) => selectedUtilities.contains(u),
                        ) // chỉ hiển thị các tiện ích đã check
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: _buildActionButton(
                        ...
                        width: selectedRoomState == ApartmentStatus.rented
                            ? 153
                            : 74,
                      ),
                    ),
                    // Chỉ hiển thị nút Cập Nhật/Tạo nếu trạng thái không phải là "Rented"
                    if (selectedRoomState != ApartmentStatus.rented)
                      GestureDetector(
                        onTap: _isSubmitting
                            ? null
                                ...
                                if (widget.initialData.roomCode.isEmpty) {
                                  ...
                                  if (isRoomCodeUnique == null) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      const SnackBar(
                                        content: Text(
                                          'Vui lòng kiểm tra tính hợp lệ của mã phòng',
                                        ),
                                      ),
                                    );
                                    return;
                                  ...
                                  RoomDetail createOrUpdateRoom = RoomDetail(
                                    ...
                                    images: await Future.wait(
                                      _images.map((img) async {
                                        ...
                                        final newName =
                                            '${DateTime.now().millisecondsSinceEpoch}_${UniqueKey().toString()}.$ext';
                        ...
                        child: _buildActionButton(
                          widget.initialData.roomCode.isNotEmpty
                              ? 'Cập Nhật'
                              : 'Tạo',
                          color: const Color(0xFF4C6FFF),
      ...
      children: [
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.hasData) {
              ...
              final connectedDevices =
                  snapshot.data![1] as List<ConnectedIotDevice>;
        ...
        FutureBuilder<List<dynamic>>(
          ...
          builder: (context, snapshot) {
            ...
            final List<IotDevice> supportedDevices =
                snapshot.data![0] as List<IotDevice>;
            final List<ConnectedIotDevice> connectedDevices =
                snapshot.data![1] as List<ConnectedIotDevice>;
              ...
              return Container(
                ...
                child: const Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Hệ thống chưa có thiết bị IOT nào được hỗ trợ',
                      ),
                    ),
                  ],
                ),
  ...
  Widget _buildMapPreview() {
    return Column(
      ...
      children: [
        Row(
          children: [
            const Icon(Icons.map_outlined, size: 20, color: Color(0xFF4C6FFF)),
            const SizedBox(width: 8),
            const Text(
              'Vị trí trên bản đồ',
              style: TextStyle(
