                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        const Divider(height: 24),
                        buildInfoRow('Check-in', '14/05 - 08:00', Icons.login_rounded),
                        const Divider(height: 24),
                        buildInfoRow('Check-out', '15/05 - 11:00', Icons.logout_rounded),
                        const Divider(height: 24),
                        buildInfoRowWithStatus('Trạng thái', bookingRequestDetail!.status ?? '', statusColor),
                        const Divider(height: 24),
                        buildInfoRow('Tiền phòng', '${bookingRequestDetail!.price ?? ''} VND', Icons.attach_money_rounded),
                      ],
                    ),
                  ),
